...
class ReviewController extends AppBaseController
{
    ...
    {
        $input = $request->all();
        $input["img"] = FileUpload::createFile($request,"img","/uploads/reviews/",true,$request->author);
    ...
    public function update($id, UpdateReviewRequest $request)
    {
        ...
        $input = $request->all();
        $input["img"] = FileUpload::updateFile($review->img,$request,"img","/uploads/reviews/",true,$request->author);
    ...
    public function destroy($id)
    {
        ...
        FileUpload::deleteFile($review->img);
